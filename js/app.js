...
function drawGrid(gridSize) {
    ...
    gameBoard.style.width = 25 * gridSize + 'px';
...
// classe
var formNode = document.getElementsByClassName('configuration')[0];
...
formNode.addEventListener('submit', function (event) {
    ...
    var newGridSize = document.getElementById('grid-size-input').value;
    console.log(newGridSize);

    // Etape 3.3.2 - Effacer l'ancienne grille
    var gameBoard = document.getElementById('invader');

    // gameBoard.firstChild pointe vers le premier enfant de gameBoard (une div.pixel quelquonque)
    ...
    // Le moment ou il n'y aura plus de noeud gameBoard.firstChild vaudra null
